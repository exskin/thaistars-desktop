...
if #available(macOS 12.0, *) {
    ...
    do {
        ...
        guard let obs = req.results?.first else { print("沒有結果"); exit(0) }
        print("檢測到實例數量: \(obs.allInstances.count)  圖像尺寸: \(obs.pixelBuffer)")
    ...
    print("系統版本太舊，不支持 instance mask")
}
